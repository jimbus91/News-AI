...
# Load the news data
#news_data = pd.read_csv(os.path.join("C:\\Users\\jimbu\\News AI\\CNBC_AAPL_News.csv")) #Windows
news_data = pd.read_csv(os.path.join("/Users/beusse/Desktop/Stocks/News AI/CNBC_AAPL_News.csv")) #Mac
